...
$"SELECT
    ...
    COALESCE(e.ContrastVisible,'') AS ContrastVisible,
    COALESCE(e.WardNotified,'') AS WardNotified,
    COALESCE(e.PatientInstructions,'') AS PatientInstructions,
                ...
                Using r = cmd.ExecuteReader()
                    While r.Read()
                        Dim d As New Dictionary(Of String, String) From {
                            ...
                            {"IsContrastExtravasation", Convert.ToString(r.GetValue(20))},
                            {"ContrastCannula", Convert.ToString(r.GetValue(21))},
                            {"ContrastType", Convert.ToString(r.GetValue(22))},
                            {"ContrastFlow", Convert.ToString(r.GetValue(23))},
                            {"ContrastVolume", Convert.ToString(r.GetValue(24))},
                            {"ContrastVisible", Convert.ToString(r.GetValue(25))},
                            {"WardNotified", Convert.ToString(r.GetValue(26))},
                            {"PatientInstructions", Convert.ToString(r.GetValue(27))},
                            {"ContrastAdditionalInfo", Convert.ToString(r.GetValue(28))},
                            {"CreatedAt", r.GetString(29)},
                            {"CreatedBy", r.GetString(30)},
                            {"UpdatedAt", r.GetString(31)},
                            {"UpdatedBy", r.GetString(32)},
                            {"ClosedAt", r.GetString(33)},
                            {"ClosedBy", r.GetString(34)},
                            {"Notes", r.GetString(35)}
                        }
                        rows.Add(d)
                    End While
                End Using
